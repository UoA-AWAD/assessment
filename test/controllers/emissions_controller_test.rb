...
class EmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emission" do
    assert_difference('Emission.count') do
      post emissions_url, params: { emission: { continent_id: @emission.continent_id, pollution: @emission.pollution, year: @emission.year } }
    end
  ...
  test "should update emission" do
    patch emission_url(@emission), params: { emission: { continent_id: @emission.continent_id, pollution: @emission.pollution, year: @emission.year } }
